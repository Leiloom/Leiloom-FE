export enum ScrapingFieldType {
  ...
  PROPERTY_ADDITIONAL_EXPENSES_DESCRIPTION = 'PROPERTY_ADDITIONAL_EXPENSES_DESCRIPTION',
  PROPERTY_ADDITIONAL_EXPENSES_VALUE = 'PROPERTY_ADDITIONAL_EXPENSES_VALUE',
  PROPERTY_AUCTIONEER_COMMISSION = 'PROPERTY_AUCTIONEER_COMMISSION',

  // Campos de VehicleAuction
  VEHICLE_YEAR_MANUFACTURING = 'VEHICLE_YEAR_MANUFACTURING',
